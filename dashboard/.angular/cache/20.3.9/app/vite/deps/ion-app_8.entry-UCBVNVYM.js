...
} from "./chunk-3BW3WS3N.js";
import {
  isRTL
} from "./chunk-7LQR22K5.js";
import {
  createLockController
} from "./chunk-S22GG4SD.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-RMM2N6CF.js";
import "./chunk-G5CYVXSQ.js";
import "./chunk-6CZAFKGE.js";
import {
  getTimeGivenProgression
} from "./chunk-HEVH5JJT.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-E6ANBBOZ.js";
import {
  createColorClasses,
  hostContext
} from "./chunk-J63BLAHY.js";
import {
  transition
} from "./chunk-XF6N36XE.js";
import {
  getIonMode,
  isPlatform
} from "./chunk-QJTDXKXW.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
...
} from "./chunk-F4BVJCBJ.js";
import "./chunk-72HAREAU.js";
import {
  Host,
  config,
  createEvent,
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-ceb5RaMT-46IGBXF4.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-5DQ7Fc4V-2EYN3JVZ.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-DyOpfTg6-RWHQCQPJ.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CPLxO-Ev-24XIWAT3.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-WXCXOC7Q.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-5APHKJTO.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
  /**
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BKw2CAHc-WURXCF42.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-app_8.entry-UCBVNVYM.js.map
